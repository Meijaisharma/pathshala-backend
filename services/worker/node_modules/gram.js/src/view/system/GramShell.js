...
define([
    ...
    'gram/base/BaseEmitter',
    'gram/env/Environment',
    'gram/view/layout/StackLayout',
    'gram/view/system/event/EventTransmitter',
    'gram/view/system/GraphicContainer',
    'gram/view/update-manager/AsyncUpdateManager',
    'gram/view/widget/Widget'
], function (
    EventEmitter,
    genetic,
    BaseEmitter,
    ...
    /**
     * The GramShell is the link between browser and GramView.
     * The GramShell manages widget's event, layouting, painting.
     ...
     * @constructor
     */
    function GramShell(container, GCFactory) {
    ...
    genetic.inherits(GramShell, BaseEmitter, {
        ...
        /**
         * Sets update-manager for the GramShell.
        ...
        /**
         * Retrives update-manager for the GramShell.
    ...
    GramShell.RootWidget = RootWidget;
