...
define([
    ...
    'gram/editor/controller/Controller',
    'gram/editor/controller/ControllerRuleFactory',
    'gram/editor/controller/RootController',
    'gram/editor/system/event/GraphicKeyHandler',
    'gram/editor/model/BaseModel',
    ...
    genetic.inherits(GraphicViewer, BaseEmitter, {
        ...
        createShell: function (container) {
            ...
            this.shell(new GramShell(container));
            return this.shell();
        },
