require(['gram/gram'], function(gram) {

    var GramShell = gram.view.system.GramShell;
    var Color = gram.base.Color;
    var Rectangle = gram.view.geometry.Rectangle;
    var StackLayout = gram.view.layout.StackLayout;
    var XYLayout = gram.view.layout.XYLayout;
    var Div = gram.view.widget.html.Div;
    var Circle = gram.view.widget.svg.Circle;
    var Ellipse = gram.view.widget.svg.Ellipse;
